...
use vars qw($VERSION @EXPORT @ISA %mon2num %wday2num $base_dir $basename $shortname $log_dir $rpt_log $delete_days $rpt_log $log_off);
...
## Use to print status to running log file throughout the script
   ...
   open (LOGIT,">>$rpt_log") or die "Connect->logit unable to open $rpt_log $!";
